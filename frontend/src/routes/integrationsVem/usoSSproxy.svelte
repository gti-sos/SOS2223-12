...
<script>
    ...
    let API2 = "http://localhost:12345/localen";//"https://sos2223-12.ew.r.appspot.com/afil";//"http://localhost:12345/evol";// Llama a /evol que esté en el backend y accede a la API de luismi
