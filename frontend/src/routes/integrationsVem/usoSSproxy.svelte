...
<script>
    ...
    let API2 = "http://localhost:12345/localen";//"https://sos2223-12.ew.r.appspot.com/localen";//"http://localhost:12345/evol";// Llama a /evol que esté en el backend y accede a la API de luismi
        ...
        resultStatus2 = result2 = "";
            ...
            if(res2.ok){
                try{
                    ...
                    grafica2.sort((a, b) => (a.president_appointment_date > b.president_appointment_date) ? 1 : ((b.president_appointment_date > a.president_appointment_date) ? -1 : 0));
